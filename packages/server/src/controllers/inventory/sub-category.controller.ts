...
export const createNewSubCategory = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
...
export const fetchAllSubCategories = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
